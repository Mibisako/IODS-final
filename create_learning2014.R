...
learning2014$DS <- ifelse((learning2014$deep_adjusted  > learning2014$surface_adjusted ), "1", "0") #creating binary variable, deep approach - 1, surface - 0
#Set the working directory of R session the IODS final project folder 
getwd()
setwd("C:/Users/Missao/Documents/GitHub/IODS-final")

#Save the analysis dataset to the ‘data’ folder
write.table(learning2014, file="C:/Users/Missao/Documents/GitHub/IODS-final/learning2014.txt", sep="\t")

#Demonstrate that you can also read the data again
demonstration<-read.table("C:/Users/Missao/Documents/GitHub/IODS-final/learning2014.txt", header=TRUE, sep="\t")
